    ...
    <Content style={{ backgroundColor: "white" }}>
      <div className="landing-subsection grid-x grid-margin-x">
        ...
        <div className="cell medium-6 large-8 subsection">
          ...
          <p>
            Around the Block is a neighborhood photo-sharing app where you can pin photos directly on the map. During the COVID pandemic, it's become important to take time to go outside, breathe fresh air, and walk around. This presents an opportunity to explore and capture the unique or even trivial things that make your town beautiful. Share your neighborhood today!
          </p>
        </div>
        ...
        <div className="cell medium-6 large-4 subsection-img-div">
          <img alt="marker-map-camera" src="https://around-the-block.s3.amazonaws.com/marker-map-camera.png" />
        </div>

        <div className="cell medium-6 large-4 subsection-img-div">
          <img alt="photo-collection" src="https://around-the-block.s3.amazonaws.com/active-collection.png" />
        </div>
        <div className="cell medium-6 large-8 subsection">
        ...
        <div className="cell medium-6 large-4 subsection-img-div">
          <img alt="polaroid" src="https://around-the-block.s3.amazonaws.com/camera-photos.png" />
        </div>
